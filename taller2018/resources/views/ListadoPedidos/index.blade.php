                        ...
                        <div class="card">
                            <div class="card-header card-header-success card-header-text">
                                ...
                                <form action="{{route('ListadoPedidos.index')}}" method="GET">
                                    ...
                                    <a style="color:#000000">Fecha inicial:</a><input name="fechaini" id="fechaini" type="date" min="1950-01-01" max="2050-12-31" />
                                    <a style="color:#000000">Fecha final:</a><input name="fechafin" id="fechafin" type="date" min="1950-01-01" max="2050-12-31" />
